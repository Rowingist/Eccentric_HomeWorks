...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        _playerInputX = transform.right * Input.GetAxisRaw("Horizontal");
        _playerInputZ = transform.forward * Input.GetAxisRaw("Vertical");
    ...
    private void FixedUpdate()
    {
        ...
        _velocity = (_playerInputX + _playerInputZ).normalized * _currentSpeed * maxSpeedChange;
